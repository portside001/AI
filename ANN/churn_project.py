...
@st.cache_data
def load_data():
    df = pd.read_csv('/Users/sachinrajput/Desktop/gen-ai-agentic-ai/AI/44_deep_learning_project/3rd, 4th -- ANN Theory , Installation/CHURN MODELING- TF_project/Churn_Modelling.csv')
    ...
    # packaging the necessary objects to return tuple
    return ann, X_test, y_test, le, ct, sc

# unpacking the returned values from load_data function
ann, X_test, y_test, le, ct, sc = load_data()
# Streamlit app
